...
AV2: Para el desarrollo de esta entrega se pudo realizar la implementación de servicios externos a nuestra aplicación. Para ello se aplicó conceptos vistos anteriormente en la carrera.\\[0.5em]
...
AV2: Durante el desarrollo es este entregable se reconoció la importancia de aprender nuevas tecnologías que ayuden a mejorar la calidad de los entregables. Dentro de la carrera, existen un gran avanico de herramientas que, en caso de no conocerse, puede hacer que algunos procesos sean tediosos y largos. Por ende, el poder reconocer la necesidad de aprendizaje continuo es importante para poder mejorar como estudiante de ingeniería de software.\\[0.5em]
{\bfseries Flor Contreras Leon}\\
