...
AV2: Participé en la configuración del entorno de desarrollo del proyecto, apoyando en la organización del repositorio y la estandarización del flujo de trabajo para el equipo. Además, colaboré en la revisión de la estructura base del proyecto para el Sprint n.\\[0.5em]
...
AV2: Participé en la gestión del código fuente mediante el control de versiones, organizando ramas y commits del equipo. Además, apoyé en la integración de funcionalidades del backend y frontend durante el Sprint n, asegurando la coherencia del desarrollo.\\[0.5em]
...
AV2: Reconocí la importancia de mejorar mis habilidades en pruebas de software y validación de sistemas, por lo que he iniciado el aprendizaje de técnicas de testing y buenas prácticas de calidad de software.\\[0.5em]
...
AV2: Profundicé en técnicas de evaluación UX y validación de productos digitales, reconociendo la importancia del aprendizaje continuo en la mejora de la experiencia de usuario basada en datos reales.\\[0.5em]
...
AV2: Se reafirma la importancia del aprendizaje continuo en tecnologías de desarrollo, integración y despliegue, fundamentales para la ejecución exitosa de proyectos de software.
...
AV2: Durante esta etapa comprendí la importancia de fortalecer continuamente mis habilidades en control de versiones, configuración de entornos y organización de proyectos, ya que son fundamentales para el desarrollo colaborativo de software.\\[0.5em]
{\bfseries Diego Andres Avalos Cordova}\\
...
AV2: En esta fase reforcé la necesidad del aprendizaje constante en integración de sistemas y despliegue de aplicaciones, investigando nuevas prácticas de desarrollo colaborativo que mejoren la calidad del producto final.\\[0.5em]
{\bfseries Piero Francesco Tenorio Medina}\\
...
AV2: Se reafirma la importancia del aprendizaje continuo en tecnologías de desarrollo, integración y despliegue, lo cual permite a los integrantes adaptarse mejor a las exigencias del proyecto y mejorar la calidad de las soluciones implementadas.
\end{minipage} \\
\hline
\end{longtable}
